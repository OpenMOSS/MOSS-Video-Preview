...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    freeze_language_model: bool = field(
        default=True,
        metadata={"help": "Whether ot not to freeze language model in MLLM training."},
    )
    ...
    disable_train_shuffling: bool = field(
        default=False,
    ...
    silence_token: Optional[str] = field(
        default=None,
        metadata={"help": "Silence token for real_time QA."},
    )
    silence_token_weight: float = field(
        default=1.0,
        metadata={"help": "Token weight for silence token."},
    )
