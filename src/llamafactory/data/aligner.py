...
def align_dataset(
    ...
    features = datasets.Features({
        '_prompt': [{'content': datasets.Value(dtype='string'), 'role': datasets.Value(dtype='string')}],
        '_response': [{'content': datasets.Value(dtype='string'), 'role': datasets.Value(dtype='string')}],
        '_system': datasets.Value('string'),
        '_tools': datasets.Value('string'),
        '_images': datasets.Sequence(datasets.Value('string')),
        '_videos': datasets.Sequence(datasets.Value('string')),
    })
